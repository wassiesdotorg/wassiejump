...
class AnimationManager {
  ...
  initAnimations() {
    ...
    const idleFrames = scene.anims.generateFrameNumbers('wassie', {
      frames: [0],
    });
    scene.anims.create({
      key: 'idle',
    ...
    const runFrames = scene.anims.generateFrameNumbers('wassie', {
      frames: [0, 3],
    });
    scene.anims.create({ key: 'run', frames: runFrames, frameRate: 10, repeat: -1 });

    const jumpFrames = scene.anims.generateFrameNumbers('wassie', {
      frames: [2],
    });
